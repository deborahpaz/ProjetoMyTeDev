...
{
    /// <inheritdoc />
    public partial class filtro2 : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WbsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WbsCodigo = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    WbsTipo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WbsDescricao = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
